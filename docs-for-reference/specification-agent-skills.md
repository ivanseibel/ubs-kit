...
The complete format specification for Agent Skills. This document defines the Agent Skills format.
...
description: Extracts text and tables from PDF files, fills PDF forms, and merges PDF documents.
...
* See [the reference guide](https://www.google.com/search?q=references/REFERENCE.md) for details.  
